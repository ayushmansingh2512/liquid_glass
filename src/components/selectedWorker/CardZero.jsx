                ...
                <div className='text-content-zero'>
                    ...
                    <div className='center-box'>
                        <div className='text-write-zero'>
                            <h1 className='main-heading-zero'>Redesigning the Contact Center Workspace</h1>
                        ...
                        <div className='metrics-container-zero'>
                            ...
                            <div className='metric-item'>
                                <p className='metric-label'>First Contact Resolution</p>
                                <div className='metric-value-container'>
                                    <img src={arrowDown} alt="Decrease" className='metric-arrow' />
                            ...
                            <div className='metric-item'>
                                <p className='metric-label'>Time-to-Information (TTI)</p>
                                <div className='metric-value-container'>
                                    <img src={arrowDown} alt="Decrease" className='metric-arrow' />
                                    <p className='metric-value'><AnimatedCounter value={20} className='metric-value' />%</p>
                                </div>
                            </div>
